...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = unemploymentBeneBaseline, weight = weight), size = 0.3) +
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = caresStimulusBaseline, weight = weight), size = 0.3) +
  scale_fill_continuous(
    labels = scales::percent,
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = foodSecurity1Baseline, weight = weight), size = 0.3) +
  scale_fill_continuous(
    labels = scales::percent,
  #  breaks = seq(0, 1, 0.2)
  ) +
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = housingRentBaseline, weight = weight), size = 0.3) +
  scale_fill_continuous(
    labels = scales::percent
  ) +
  theme_void() +
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = yearArrive, weight = weight), size = 0.3) +
  theme_void() +
  #theme(legend.position = "bottom") +
  labs(
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = birthYear, weight = weight), size = 0.3) +
  theme_void() +
  #theme(legend.position = "bottom") +
  labs(
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = householdSize %>% as_factor(), weight = weight), size = 0.3) +
  scale_fill_brewer(
  #  breaks = seq(0, 10, 1)
  ) +
  theme_void() +
...
ussf::boundaries(geography = "state") %>% 
  ...
  ggplot() +
  geom_sf(aes(fill = householdChildren %>% as_factor(), weight = weight), size = 0.3) +
  scale_fill_brewer(
  #  breaks = seq(0, 10, 1)
  ) +
  theme_void() +
